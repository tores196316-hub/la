          ...
          <div className="w-full max-w-sm rounded-xl bg-[#0e1017] border border-white/[0.1] p-6 text-left space-y-4 shadow-2xl">
            ...
            {forgotSuccess ? (
              <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs flex items-center gap-2">
                ...
                <span>Şifre sıfırlama talimatı e-posta adresinize iletildi.</span>
              </div>
            ) : (
              <form onSubmit={handleForgotSubmit} className="space-y-3">
                ...
                <div className="flex items-center justify-end gap-2 pt-2">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-1.5 rounded-lg bg-white text-black font-semibold text-xs hover:bg-slate-200"
                  >
                    Bağlantı Gönder
                  </button>
                </div>
